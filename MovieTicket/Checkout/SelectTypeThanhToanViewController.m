...
#define SECTION_MOBILE  2
#define SECTION_TYPE_THANHTOAN 3
#define SECTION_LOGIN 4
...
//    NSArray* contactList = [self getListOfUserContact];
//    for (NSString* item in contactList) {
//        LOG_123PHIM(@"%@", item);
//    }
}
...
{
    if (section == SECTION_INFO || section == SECTION_TYPE_THANHTOAN) {
        return 2;
    }
    return 1;
}
