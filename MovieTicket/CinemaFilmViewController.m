...
{    
    ...
    if (curCinemaDistance.cinema.discount_type.intValue == ENUM_DISCOUNT_PERCENT)
    {
        [[cell lbDiscount] setText:[NSString stringWithFormat:@"-%d%@", curCinemaDistance.cinema.discount_value.intValue,@"%"]];
    }
    else if (curCinemaDistance.cinema.discount_type.intValue == ENUM_DISCOUNT_MONEY)
    {
        [[cell lbDiscount] setText:[NSString stringWithFormat:@"-%dK", curCinemaDistance.cinema.discount_value.intValue/1000]];
    }
    else
    {
...
//        if(self.curCinemaDistance.cinema.arrayIdListFilm == nil || [self.curCinemaDistance.cinema.arrayIdListFilm count] == 0)
//        {
//            self.curCinemaDistance.cinema.arrayIdListFilm = [[[self.curCinemaDistance.cinema.cinema_list_film componentsSeparatedByString:@","] mutableCopy] autorelease];
//        }
