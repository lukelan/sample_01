...
#define SECTION_FILM_INFO 0
#define SECTION_NEWS_BANNER 1
#define DEFAULT_SECTION_HEADER 2
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section > SECTION_FILM_INFO)
    {
        ...
        [retCell loadDataWithOnline:isOnline
                        cinemaName:cinemaName
                          film2D3D:film2D3D
                     cinemaAddress:cinemaAddress
                          distance:cinema_distance.distance
                        withMargin:MARGIN_EDGE_TABLE_GROUP/2
                      isVNeseVoice:((Session*)[cinema_distance.arraySessions objectAtIndex:0]).is_voice withHeight:heightCell];
...
#pragma mark UIScrollViewDelegate of UITableView
// Somewhere in your implementation file:
//- (void) scrollViewDidEndDecelerating:(UIScrollView *)scrollView
//{
//    //    LOG_123PHIM(@"111----scrollViewDidEndDecelerating");
