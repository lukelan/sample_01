...
-(void)showKeyBoard:(NSNotification*)notification
{
    ...
    while (v.superview && v != currentViewController.view && ![v isKindOfClass:[UIScrollView class]])
    {
...
//        [self performSelector:@selector(doHideKeyboardAnimation:) withObject:sv afterDelay:0.3]; // wait anim of contentoffset done
    }
    else
    {
